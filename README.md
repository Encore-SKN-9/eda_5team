...
##### ***2. 교육수준과 성인 사망자 수의 관계 분석***
<div>
  <img  width=47% src="./readme_images/jaehyeok/Reions_scatter.png">
  <img  width=40% src="./readme_images/jaehyeok/Region_Scatter_line.png">
</div>
...
#### 교육연수 기간과 성인 사망자 수의 관계
- 교육을 받는 기간이 길어질수록 성인 사망자 수가 줄어든다는 것을 corr 상관관계를 통해서 확인할수 있었다.
- 이 수치가 맞는지 확인하기 위해 대륙별로 나눠서 산포도를 찍어봤고 교육기간이 길어질수록 사망자 수는 감소하는 음의 관계를 보이는것을 확인했다.
